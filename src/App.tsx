  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-white border-b border-border-gray h-20 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 md:px-8 h-full flex justify-between items-center">
        <button
          type="button"
          aria-label="Horizon Agro — go to home"
          className="font-display text-xl md:text-2xl font-bold text-deep-forest tracking-tight -mx-2 px-2 py-2 cursor-pointer"
          onClick={() => go('/')}
        >
          HORIZON AGRO
        </button>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-12">
          <div className="col-span-2 md:col-span-1">
            <button
              ...
              className="font-display text-2xl font-bold mb-4 tracking-tight -mx-2 px-2 py-1 text-left cursor-pointer hover:text-tertiary transition-colors"
            >
              HORIZON AGRO
            </button>
